...
const technologyLogoSpecs = [
  ...
  { name: "GitHub", wordmark: "GitHub", wordmarkClassName: "text-white" },
  { name: "Docker", wordmark: "Docker", wordmarkClassName: "text-sky-300" },
  { name: "Kubernetes", image: kubernetesLogo },
  { name: "Terraform", wordmark: "Terraform", wordmarkClassName: "text-violet-300" },
];
...
export function AIEngineeringSoftwareDevelopment() {
  ...
  return <EnterprisePage content={enterprisePages.aiEngineering} />;
}
