  ...
  nav: {
    items: [
      ...
      { label: "About", href: "/about" },
      {
        ...
        href: "/#expertise",
        dropdown: [
          { label: "AI Strategy & Enterprise Transformation", href: "/ai-transformation" },
          { label: "Generative & Agentic AI", href: "/generative-ai-agentic-ai" },
          { label: "Data Engineering & AI Foundations", href: "/data-engineering-ai-foundations" },
          { label: "AI Engineering & Software Development", href: "/ai-engineering-software-development" },
          { label: "AI Governance & Cybersecurity", href: "/ai-governance-cybersecurity" },
          { label: "Cloud, Infrastructure & AI Compute", href: "/cloud-infrastructure-ai-compute" },
        ],
      },
      {
        label: "Industries",
      ...
      { label: "Solutions", href: "/enterprise-ai-solutions" },
      {
        ...
        href: "/products",
        dropdown: [
          { label: "Seismic AI", href: "https://seismicai.ca", external: true },
          { label: "DCI 360", href: "/products/dci-360" },
          { label: "i-Lakehouse", href: "/products/i-lakehouse" },
          { label: "ADRS", href: "/products/adrs" },
        ],
      },
    ...
    items: [
      {
        ...
        body: "Strategy, roadmap, operating model, and delivery planning for intelligent enterprise transformation.",
      },
      {
        id: "02",
        slug: "generative-ai-agentic-ai",
        title: "Generative & Agentic AI",
        body: "Enterprise assistants, copilots, RAG systems, agents, and workflow automation with controls.",
      },
      {
        id: "03",
        slug: "data-engineering-ai-foundations",
        title: "Data Engineering & AI Foundations",
        body: "Governed data platforms, lakehouse foundations, pipelines, quality, lineage, analytics, and MLOps.",
      },
      {
        id: "04",
        slug: "ai-engineering-software-development",
        title: "AI Engineering & Software Development",
        body: "Production AI applications, SaaS platforms, copilots, RAG apps, intelligent automation, and modernization.",
      },
      {
        id: "05",
        slug: "ai-governance-cybersecurity",
        title: "AI Governance & Cybersecurity",
        body: "AI governance, lifecycle controls, LLM security, data leakage assessment, IAM, and threat modelling.",
      },
      {
        id: "06",
        slug: "cloud-infrastructure-ai-compute",
        title: "Cloud, Infrastructure & AI Compute",
        body: "Cloud architecture, platform engineering, Kubernetes, observability, automation, and AI compute planning.",
      },
    ],
